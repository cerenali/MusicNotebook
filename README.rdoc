...
=== Heroku Add-Ons
I added the SendGrid add-on to my Heroku app. At first, I had problems with the
SendGrid environmental variables, as some of them were not set in Heroku.
This was resolved by setting the missing environment variable in Heroku:
